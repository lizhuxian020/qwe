...
+(void)customFromMonth:(int)fromM{
    LYSDatePickerController *datePicker = [LYSDatePickerController shareInstance];
    datePicker.fromMonth = fromM;
}

+(void)customFromDay:(int)fromD{
    LYSDatePickerController *datePicker = [LYSDatePickerController shareInstance];
    datePicker.fromD = fromD;
}

+(void)customFromHour:(int)fromH{
    LYSDatePickerController *datePicker = [LYSDatePickerController shareInstance];
    datePicker.fromH = fromH;
}

+(void)customFromMin:(int)fromMin{
    LYSDatePickerController *datePicker = [LYSDatePickerController shareInstance];
    datePicker.fromM = fromMin;
}
