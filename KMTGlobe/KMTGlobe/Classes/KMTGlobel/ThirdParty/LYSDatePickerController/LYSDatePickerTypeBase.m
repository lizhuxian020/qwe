...
{
    return [self.pickerManager fetchMonthsWithYear:self.currentYear andFromMonth:self.fromM];
}

- (NSArray<NSString *> *)days
{
    return [self.pickerManager fetchDaysWithYear:self.currentYear month:self.currentMonth fromD:self.fromD];
}
...
{
    return [self.pickerManager fetchHourFromH:self.fromH];
}

- (NSArray<NSString *> *)minutes
{
    return [self.pickerManager fetchMinutesFromM:self.fromMin];
}
