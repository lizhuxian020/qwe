...
- (void)initPickerType {
    ...
    self.typeBase.fromMin = self.fromM;
    self.typeBase.fromM = self.fromMonth;
    self.typeBase.fromD = self.fromD;
    self.typeBase.fromH = self.fromH;
...
-(void)setStartDate:(NSDate *)startDate{
    ...
    self.fromYear = [[formatter stringFromDate:startDate] intValue];
    [formatter setDateFormat:@"MM"];
    self.fromMonth = [[formatter stringFromDate:startDate]intValue];
    [formatter setDateFormat:@"dd"];
    self.fromD = [[formatter stringFromDate:startDate] intValue];
    [formatter setDateFormat:@"hh"];
    self.fromH = [[formatter stringFromDate:startDate] intValue];
    [formatter setDateFormat:@"mm"];
    self.fromM = [[formatter stringFromDate:startDate] intValue];
}
