...
typedef void(^textFieldChangedblock)(UITextField *tf,NSRange range,NSString *string);

typedef void(^textFieldEndblock)(UITextField *tf, NSString *string);
...
@property(nonatomic,copy)textFieldChangedblock shouldChangeBlock;

@property(nonatomic,copy)textFieldEndblock endBlock;
