...
- (id)initWithFrame:(CGRect)frame WithTitle :(NSString *)title
{
    ...
    if (self)
    {
        ...
        _lable_title.frame = CGRectMake(0, 20, SCREEN_WIDTH, LabelHeight);
        ...
        ///  假的输入框
        _view_box = [[UIView alloc]initWithFrame:CGRectMake(10, tfHeight, boxWidth, boxWidth)];
        [_view_box.layer setBorderWidth:1.0];
        [_view_box.layer setCornerRadius:3];
        [_view_box.layer setMasksToBounds:YES];
        ...
        [_view_box2.layer setCornerRadius:3];
        [_view_box2.layer setMasksToBounds:YES];
        ...
        [_view_box3.layer setCornerRadius:3];
        [_view_box3.layer setMasksToBounds:YES];
        ...
        [_view_box4.layer setCornerRadius:3];
        [_view_box4.layer setMasksToBounds:YES];
        ...
        [_view_box5.layer setCornerRadius:3];
        [_view_box5.layer setMasksToBounds:YES];
        ...
        [_view_box6.layer setCornerRadius:3];
        [_view_box6.layer setMasksToBounds:YES];
...
- (void) textFieldDidChange:(id) sender
{
    ...
    {        
     ...
     //   self.endBlock(_field, _field.text);
}
...
-(BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string{
    if (self.shouldChangeBlock) {
        self.shouldChangeBlock(textField, range, string);
    }
    if (range.location + 1 > 6) {
        return false;
    }
    return YES;
}
