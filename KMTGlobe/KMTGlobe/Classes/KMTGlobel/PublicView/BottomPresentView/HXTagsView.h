...
typedef void(^tagClickedBlock)(NSInteger index,NSString *title,UIButton *btn);
@class HXTagsView;
...
-(void)setTagAry:(NSArray *)tagAry Block:(void(^)(NSInteger index,NSString *title,UIButton *btn))ckickedBlock;
