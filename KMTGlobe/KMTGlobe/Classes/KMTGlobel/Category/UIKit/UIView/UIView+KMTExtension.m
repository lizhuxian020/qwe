...
#import "UIView+KMTExtension.h"
#import <QuartzCore/QuartzCore.h>

@implementation UIView (KMTExtension)
...
+(UIView *)drawLineView:(CGFloat)speace{
    UIView *view = [[UIView alloc]initWithFrame:Rect(speace, 0, ScreenWidth - speace * 2, 0.5)];
